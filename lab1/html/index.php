	...
	<main>
		<section class="hero" id="hero">
			<div class="content">
				...
				<p>
					<?php
					echo 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est accusantium voluptas eligendi maiores
					ad quae ullam eveniet aut dolores unde. Eos dignissimos mollitia tenetur quaerat dolores, molestiae
					nobis iure non. <span class="text">This block was added by PHP</span>
					<span class="text">This block was added by PHP</span>
					Lorem ipsum dolor sit amet consectetur adipisicing <span class="text">This block was added by PHP</span>elit. Beatae porro dolores voluptates inventore
					ea, ratione adipisci cupiditate maiores laboriosam deleniti, modi, labore eaque pariatur assumenda
					non! Modi animi ipsam totam.
					Laudantium <span class="text">This block was added by PHP</span>mollitia porro culpa, eius iste fugiat, cupiditate vero facere pariatur praesentium
					officiis. Voluptatem <span class="text">This block was added by PHP</span>commodi nulla aspernatur iure veritatis exercitationem quas tenetur harum iste
					ipsam! <span class="text">This block was added by PHP</span>Perspiciatis, repellat nulla! Blanditiis, doloremque?';
					?>
				</p>
				<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="blank" class="bstyle">
					Hire me
				</a>
			</div>
		</section>
		...
		<footer>
			<div class="fio">
				...
				<h2>Журавлев</h2>
				<h3>Давид</h3>
				<h2>Надо было сделать что то что бы отобразилось через php</h2>
			</div>
			<!-- <form action="#" class="callform">
				<h2 class="logo">Leave your contact information</h2>
				<input type="text" placeholder="John Phedor" required>
				<input type="tel" placeholder="8 (985) 431 31 27" required>
				<div class="ch">
					<input type="checkbox" id="foo" value="important">
					<label class="radio" for="foo">чекбокс для срочной связи</label>
				</div>
